...
template = ChatPromptTemplate.from_messages([
    ("system", "Eres un traductor profesional. Traduce el texto del usuario al idioma {idioma} y determina si el tono es {tono}."),
    ("user", "Hola, quiero traducir esta frase a {idioma}. El usuario dice: {texto}")
])
